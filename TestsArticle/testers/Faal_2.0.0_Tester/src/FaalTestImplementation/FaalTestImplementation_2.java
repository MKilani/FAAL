...
public class FaalTestImplementation_2 {
	...
	public static void main(String[] args) throws Exception {
		...
		String nameDataset = "path/to/data/dataset/2_corpus_faal_input_no_alignments.txt";
		...
		String nameResult = "path/to/folder/with/results/2_faal_results.txt";
		...
		try {
			...
			for (int i = 1; i < items.length; i = i + 3) {
				...
				listResultsAlignments = FAAL.align(word1, word2, false, 4);
