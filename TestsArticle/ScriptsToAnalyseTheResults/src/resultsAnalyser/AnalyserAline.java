...
public static void main(String[] args) throws Exception {
		...
		String inputFileResultAnalysis = "2_aline_results.txt"; //file with the results obtained by aline - those obtained in the tests are provided in the folder: TestsArticle/Datasets/Results
		String benchmarkFile = "2_corpus_aline_benchmark.txt"; //benchmark file with the correct alignments for aline - provided in the folder: TestsArticle/Datasets/Benchmarks
		String suffixMethod_Results = "aline_2.txt"; //suffix indicating the method to use in the names of the output files (suggested: aline + _ + nrCorpus)
		...
		for (int i = 3; i < lines.length; i = i+6){
			...
			for (int n = 1; n < word1.length; n++){
				...
				lines[i+1] = lines[i+1] + ";" + word2[n];
			}
			
			resultLines.add("ID: " + String.valueOf(f));
