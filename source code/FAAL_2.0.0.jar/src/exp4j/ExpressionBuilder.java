...
import exp4j.function.Function;
import exp4j.function.Functions;
import exp4j.operator.Operator;
import exp4j.shuntingyard.ShuntingYard;
...
public class ExpressionBuilder {
    ...
    /**
     * Add a {@link exp4j.function.Function} implementation available for use in the expression
     * @param function the custom {@link exp4j.function.Function} implementation that should be available for use in the expression.
    ...
    /**
     * Add multiple {@link exp4j.function.Function} implementations available for use in the expression
     * @param functions the custom {@link exp4j.function.Function} implementations
     * @return the ExpressionBuilder instance
     */
    ...
    /**
     * Add multiple {@link exp4j.function.Function} implementations available for use in the expression
     * @param functions A {@link java.util.List} of custom {@link exp4j.function.Function} implementations
     * @return the ExpressionBuilder instance
     */
    ...
    /**
     * Add an {@link exp4j.operator.Operator} which should be available for use in the expression
     * @param operator the custom {@link exp4j.operator.Operator} to add
     * @return the ExpressionBuilder instance
     */
    ...
    /**
     * Add multiple {@link exp4j.operator.Operator} implementations which should be available for use in the expression
     * @param operators the set of custom {@link exp4j.operator.Operator} implementations to add
     * @return the ExpressionBuilder instance
     */
    ...
    /**
     * Add multiple {@link exp4j.operator.Operator} implementations which should be available for use in the expression
     * @param operators the {@link java.util.List} of custom {@link exp4j.operator.Operator} implementations to add
     * @return the ExpressionBuilder instance
     */
